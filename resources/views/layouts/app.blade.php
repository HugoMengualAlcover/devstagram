            ...
            <div class="container mx-auto flex justify-between items center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        ...
                        class="flex items-cener gap-2 bg-white border text-gray-500 p-1 rounded text-sm uppercase font-bold cursor-pointer"
                        >
